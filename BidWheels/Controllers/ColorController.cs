...
namespace BidWheels.Controllers
{
    ...
    public class ColorController : Controller
	{
		...
		public ColorController(IColorService entityService)
		{
		...
		public IActionResult Create([Bind("Id,Name,Type")] Color entity)
		{
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public IActionResult Edit(int id, [Bind("Id,Name,Type")] Color entity)
		{
			if (id != entity.Id)
			{
				return NotFound();
